...
async function getUserProfile() {
  ...
  try {
    ...
    alert(
      "Ocorreu um erro ao busccar o perfil do usuário. Por favor, tente novamente mais tarde.Usuário não encontrado. Por favor, verifique o nome de usuário e tente novamente."
    );
    profileResults.innerHTML = "";
  }
}
